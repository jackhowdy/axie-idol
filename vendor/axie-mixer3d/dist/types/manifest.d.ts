import type { AxieBodyType, AxieDescriptor, AxieGeneClass, AxiePartAssetId, AxiePartDescriptor, AxiePartType, AxieRigType } from './domain.js';
import type { AxieAnimationCoordinateSpace } from './exporter-schema.js';
export declare const AXIE_MANIFEST_SCHEMA_VERSION: 2;
...
export type AxieJsonValue = null | boolean | number | string | readonly AxieJsonValue[] | {
...
export interface AxiePartAssetManifest {
    ...
    readonly descriptor: AxiePartDescriptor & {
        readonly class: AxieGeneClass;
    };
...
export interface AxieTextureMipChainManifest {
    ...
    readonly rawTransform: 'bc1-flip-y-block-and-selector-rows-v1' | 'bc3-flip-y-block-alpha-and-color-selector-rows-v1' | 'unity-decoded-png-levels-v1';
...
export interface AxieWeaponPairedAnimationSetManifest {
    readonly schemaVersion: 1;
    readonly clips: Readonly<Record<AxieWeaponPairedAnimationState, AxieWeaponPairedAnimationClipManifest>>;
}
...
export declare function resolveAxieBodyRestReferenceBody(lod: AxieLodManifest, partId: AxiePartAssetId): AxieBodyType;
