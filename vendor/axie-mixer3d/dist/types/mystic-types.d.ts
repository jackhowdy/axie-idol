...
export type MysticDiagnosticCode = 'mystic-catalog-invalid' | 'mystic-shader-unsupported' | 'mystic-material-missing' | 'mystic-texture-missing' | 'addon-prefab-missing' | 'addon-particle-module-unsupported' | 'addon-render-mode-unsupported' | 'addon-material-missing' | 'addon-particle-budget-clamped';
...
export interface MysticGradientSchema {
    ...
    readonly alphaKeys: readonly Readonly<{
        time: number;
        alpha: number;
    }>[];
}
...
export type MysticTextureResolver = (slot: MysticTextureSlotSchema, material: MysticMaterialSchema) => THREE.Texture | null | undefined;
...
//# sourceMappingURL=mystic-types.d.ts.map