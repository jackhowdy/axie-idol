 ...
 */
export type AxieAnimationCoordinateSpace = 'unity-source-local-v1' | 'target-glb-local-v1';
...
export declare function isAxieExporterAnimationPayloadV1(value: unknown): value is AxieExporterAnimationPayloadV1;
//# sourceMappingURL=exporter-schema.d.ts.map