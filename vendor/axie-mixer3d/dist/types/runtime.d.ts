...
import type { AnimationClip, Group, Material, Object3D, Texture, WebGLRenderer, WebGLRenderTarget } from 'three';
import type { AxieAvatarRenderOptions, AxieAvatarRenderResult } from './avatar.js';
import type { AxieDecodedGenes, AxieDescriptor, AxieGenesDecoder, AxiePartAssetId, AxiePartType, AxieRigType } from './domain.js';
import type { AxieAnimationSet, AxieBodyAssetManifest, AxieLodManifest, AxieMaterialManifest, AxieMixerManifest, AxiePartRigManifest, AxieTextureManifest, AxieWeaponManifest, AxieWeaponPairedAnimationState } from './manifest.js';
import type { AxieQualityId, AxieQualityProfile } from './quality.js';
import type { AxieAssemblyDiagnostics, AxieCacheDiagnostics, AxieDiagnosticEvent } from './diagnostics.js';
import type { AxieIdInput, AxieLookup, AxieResolver } from './axie-id.js';
export declare const AXIE_SOURCE_ART_MODE: "faithful";
...
export type AxieLoadStage = 'manifest' | 'plan' | 'body' | 'parts' | 'textures' | 'materials' | 'addons' | 'animations' | 'finalize';
...
export interface AxieCreateRequest extends Omit<AxieMixRequest, 'quality' | 'artMode' | 'strict' | 'animationSet'> {
...
export interface AxieAssetStore {
    ...
    acquireTexture(texture: AxieTextureManifest, quality: AxieQualityProfile, signal?: AbortSignal): Promise<AxieAssetLease<Texture>>;
...
export interface AxiePlayableCharacter {
    ...
    renderAvatar(renderer: WebGLRenderer, target: WebGLRenderTarget, options?: AxieAvatarRenderOptions): AxieAvatarRenderResult;
