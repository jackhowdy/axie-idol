...
These are the working notes kept while the project grew, including screens that R1 hides behind a flag. The README at the top of the repository is the current description.
